<x-app-layout>
    <div class="profile-container min-h-screen flex p-10 justify-start w-full px-20 py-8 bg-gray-800 text-white">
        <div class="grid grid-cols-3 gap-4 w-full h-100 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-700 dark:border-gray-700">
            <div class="col-span-1 p-2 h-96 w-96 bg-gray-900 border border-teal-500 rounded-lg">
                <div class="p-6 bg-gray-900 border border-green-900 rounded-lg">
                    <img class="h-[300px] w-[350px] object-cover rounded-full" src="{{ asset('storage/' . $user->image ) }}" id="preview-image" alt="Post Photo">
                    <h1 class="flex justify-center pt-7 text-2xl text-gray-300">{{ $user->name }}</h1>
                    <small class="flex justify-center text-gray-400">{{ $user->biography }}</small><br>
                </div>  
                <h5 class="flex justify-center py-2 text-gray-200">Links</h5>
            ...
            <div class="col-span-2 grid cols-1 pl-16">
                <h2 class="text-gray-200 pl-24 flex justify-center text-3xl mt-10">
                    All Post
                </h2>
                    ...
                    @foreach ($user->posts as $post)                                                   
                        <a href="{{ route('editpost.edit', ['post' => $post->id]) }}" class="mb-2 flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-teal-800">
                            ...
                            <div class="flex flex-col justify-start p-4 leading-normal">
                                ...
                                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">{{ $post->title }}</p>
